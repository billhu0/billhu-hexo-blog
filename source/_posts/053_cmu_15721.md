...
- Partition phase
  ...
  - ![](053_cmu_15721/partition-phas.png)
- Probe phase
  - 将两个表的对应bucket逐一进行hash join。（此处hash join的体积较小）。
  - ![](053_cmu_15721/probe-phase.png)
...
- ![](053_cmu_15721/impediments-to-speedup.png)
...
![](053_cmu_15721/lock-compatibility.png)
...
![](053_cmu_15721/isolation-level.png)
...
- Locking (Growing) Phase, Unlocking (Shrinking) Phase
  ...
  - 否则会无法保证serializable，例如
    ...
    ![](053_cmu_15721/lock-grow-shrink-counterexample.png)
...
# Lec 8. OCC-Optimistic Concurrency Control
...
# Lec 10. Generalized Isolation Level
