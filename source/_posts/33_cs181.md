...
- conversion to CNF
  - 1: 把 $A\Leftrightarrow B$ 换成 $(A\Rightarrow B) \and (B\Rightarrow A)$
...
为了证明 $A|=B$, 我们去证明 $A \and \lnot B$ unsatisfiable.

- Step 1. Start from $A \and \lnot B$

- Step 2. Build a set $S$ of sub-formulas

  - Write $A \and \lnot B$ in CNF (写成 $P_1 \and P_2 \and \cdots \and P_k$ 形式)
  - Let $S = {P_1, \cdots, P_k}$

- Step 3. 对 $S$ 做 resolution: $(X\or Y)\and (\lnot X \or Z) \Rightarrow Y \or Z$

  注: 不能说 $(X\or Y)\and (\lnot X \or Z) \equiv Y \or Z$
...
- **形式**: $P_1 \and P_2 \and \cdots \and P_n \Rightarrow Q$  或  $\lnot P_1 \or \lnot P_2 \or \cdots \or \lnot P_n \Rightarrow Q$ 
